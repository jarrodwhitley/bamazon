...
export default function DiscountBadge({ discountPercentage, singleProductView = false }) {
    ...
    return (
        <div className={(singleProductView ? 'ml-4 p-0 h-fit' : 'absolute -top-2 -left-1 p-1') + ' discount-badge bg-[indianred] text-white w-fit text-md px-2 font-semibold rounded-md'}>
