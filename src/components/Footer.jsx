        ...
        <>
            {!isFiltering && (
                <footer className="h-[500px] bg-blue-950 mt-6 text-white">
                    <div className="footer-content grid grid-rows-1 grid-cols-4 w-full pt-8 px-10 gap-4 text-sm max-w-[1400px] mx-auto">
                        <div className={'row-start-1 col-start-1'}>
                            <figure className="footer-logo w-fit h-fit flex items-center justify-center">
                                <img src={BamazonLogo} className={'object-contain'} width={120} alt="BAMazon logo"/>
                            </figure>
                            <div className={'footer-links__lorem flex flex-col row-start-2 col-start-1'}>
                        ...
                        <div className="footer-links__navigation flex col-start-2 flex-col gap-2">
                            <div className={'text-lg font-semibold'}>Site</div>
                            <a href="#">Home</a>
                            <a href="#">About</a>
                            <a href="#">Contact</a>
                        </div>
                        <div className="footer-links__legal flex flex-col row-start-2 col-start-3 gap-2">
                            <div className={'text-lg font-semibold mt-6'}>Legal</div>
                            <a href="#">Privacy Policy</a>
                            <a href="#">Terms of Service</a>
                            <a href="#">Accessibility</a>
                        </div>
                        <div className="footer-links__contact flex flex-col row-start-1 col-start-3 gap-2">
                            <div className={'text-lg font-semibold'}>Contact</div>
                            <a>123-456-7890</a>
                            <a>5555 Fake St, Springfield, IL 62701</a>
                            <a>hello@bamazon.com</a>
                        </div>
                        <div className="footer-links__social flex flex-col row-start-1 col-start-4 gap-2">
                        ...
                        <div className={'footer-links__help flex flex-col row-start-2 col-start-4 gap-2'}>
