...
//                             <ProductCard key={product.id} product={product} showLowStock={true} />
//                         ))}
//                         {filteredProductsState.length === 0 && <div className="content__no-results text-2xl font-semibold text-center w-full row-span-full col-span-full place-self-center mt-4">No results found</div>}
//                     </div>
//                     {isMobile && (
//                         <div className={'content__filter-clear flex items-center justify-center text-base font-semibold text-gray-400 cursor-pointer w-fit hover:text-blue-400 p-4'} onClick={handleClearFilters}>
