...
export default function LoadingOverlay({ isLoading }) {
    ...
    return (
        <div className={(showOverlay ? '' : 'animate__fadeOut pointer-events-none ') + 'loading-overlay animate__animated absolute top-0 left-0 w-full h-screen bg-white z-20 grid grid-cols-1 grid-rows-1 items-center justify-items-center'}>
